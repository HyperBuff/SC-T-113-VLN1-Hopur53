...
class ContractUI:
    ...
    def select_contract(self, contract_id):
        while True:
            ...
            print("Id:\t\t\t\t{}\nName:\t\t\t\t{}\nPhone:\t\t\t\t{}\nEmail:\t\t\t\t{}\nAddress:\t\t\t{}\nVehicle Id:\t\t\t{}\nVehicle Status:\t\t\t{}\nEmployee Id:\t\t\t{}\nLocation:\t\t\t{}\nDate From:\t\t\t{}\nDate To:\t\t\t{}\nLoan date:\t\t\t{}\nLoan status:\t\t\t{}\nReturn date:\t\t\t{}\nTotal:\t\t\t\t{}\n".format(contract.id, contract.name, contract.phone, contract.email, contract.address, contract.vehicle_id, contract.vehicle_status, contract.employee_id, contract.location, contract.date_from, contract.date_to, contract.loan_date, contract.loan_status, contract.return_date, contract.total))
            self.printer.new_line()
            self.printer.print_fail("Press q to go back")
            self.print_msg()
